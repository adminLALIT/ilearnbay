...
/**
 * phonepe enrolment plugin utility class.
 *
...
final class util {
     ...
     * @param stdClass $data    phonepe IPN data
     */
    public static function message_phonepe_error_to_admin($subject, $data) {
        $admin = get_admin();
        $site = get_site();
        ...
        $eventdata->subject           = "phonepe ERROR: ".$subject;
    ...
    public static function get_exception_handler() {
        return function($ex) {
            ...
            $logerrmsg = "enrol_phonepe IPN exception handler: ".$info->message;
