...
/**
 * Contains helper class to work with phonepe REST API.
 *
...
class phonepe_helper {
     ...
     * @param string $secret phonepe secret.
    ...
    public function __construct(string $clientid, string $secret, bool $sandbox) {
        ...
        $this->secret = $secret;
        $this->baseurl = $sandbox ? 'https://api.sandbox.phonepe.com' : 'https://api.phonepe.com';
     ...
     *
     * @param string $authorizationid The phonepe-generated ID for the authorized payment to capture.
    ...
    /**
     * Captures order details from phonepe.
     *
    ...
    /**
     * Request for phonepe REST oath bearer token.
     *
     * @return string
     */
