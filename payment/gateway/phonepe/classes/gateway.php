...
/**
 * Contains class for phonepe payment gateway.
 *
...
/**
 * The gateway class for phonepe payment gateway.
 *
 * @copyright  2019 Shamim Rezaie <shamim@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class gateway extends \core_payment\gateway {
    ...
    public static function add_configuration_to_gateway_form(\core_payment\form\account_gateway $form): void {
        ...
        $mform->addElement('text', 'merchantid', get_string('merchantid', 'paygw_phonepe'));
        $mform->setType('merchantid', PARAM_TEXT);
        
        $mform->addElement('text', 'saltkey', get_string('saltkey', 'paygw_phonepe'));
        $mform->setType('saltkey', PARAM_TEXT);
