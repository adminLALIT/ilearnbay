 ...
 */
class domain_list extends table_sql
{
  /**
   * Constructor
  ...
  function __construct($uniqueid)
  {
    ...
    $columns = array('name', 'domain', 'action');
    $this->define_columns($columns);

    // Define the titles of columns to show in header.
    $headers = array('Company', 'Domain', 'Action');
  ...
  function col_action($values)
  {
    ...
    $baseurl = new moodle_url('/local/recommendation/domain_list.php');
