...
$PAGE->set_title('Manage Mapped Domains');
$PAGE->set_heading('Manage Mapped Domains');
...
$table = new mapped_list('uniqueid');
...
$field = 'dm.*, c.name, ccd.domain';
$from = "{domain_mapping} dm JOIN {company} c ON c.id = dm.companyid LEFT JOIN {company_course_domain} ccd ON ccd.id = dm.domainid";
// Work out the sql for the table.
$table->set_sql($field, $from, $where);
$table->define_baseurl("$CFG->wwwroot/local/recommendation/mapped_list.php");
